...
public static void main(String args[]) 
{
 ...
 cu.enrollStudentInCourse(s4, c11); // This student is alreadyregistered in this course, and should not be added twice
 cu.enrollStudentInCourse(s4, c11); // Again this should not work
 System.out.println("The University looks as follows: " + cu); // 10students & 26 courses
 System.out.println("Attempting to cancel \" Introductory Biology I\"...");
 cu.cancelCourse(c1); // Should not work, but should not stop programeither
